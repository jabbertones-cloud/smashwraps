/** FAQ copy — align answers with counsel-approved claims and compliance memo. */
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Shipping availability and restrictions depend on product classification, carrier rules, and destination. Update this answer after counsel and operations sign-off.",
  },
  {
    question: "What is your return policy?",
    answer:
      "See the Returns page for the policy template. Replace with final terms before launch.",
  },
  {
    question: "How old do I need to be to purchase?",
    answer:
      "Age requirements depend on product facts and jurisdiction. Implement the exact flow described in your compliance memo — this site includes a placeholder age attestation only.",
  },
  {
