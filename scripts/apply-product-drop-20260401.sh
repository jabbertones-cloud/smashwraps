...
cp -f "$ASSETS/image-08432847-a24b-47b0-bd44-919c25dd6e94.png" "$OUT/IcedWatermelonChops.png"
cp -f "$ASSETS/image-091b0890-6160-4e90-b04b-843476aedcd6.png" "$OUT/PassionFruitChops.png"
cp -f "$ASSETS/image-01b328c1-c7d2-4858-9e8e-df1e8662756b.png" "$OUT/PineappleChops.png"
cp -f "$ASSETS/image-a6375aa4-9075-44c8-a3dd-33f1610253fc.png" "$OUT/VanillaChops.png"

cp -f "$ASSETS/image-08432847-a24b-47b0-bd44-919c25dd6e94.png" "$OUT/AllCaseBoxesChops.png"
