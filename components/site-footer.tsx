  ...
  return (
    <footer className="border-t border-white/[0.08] bg-[#030303] pb-[max(3.5rem,calc(env(safe-area-inset-bottom)+2.5rem))] pt-14">
      <div className="section-inner text-center">
        ...
        <p className="mx-auto mt-6 max-w-md text-legal leading-relaxed text-zinc-600">
        ...
        <div className="mx-auto mt-10 max-w-md text-left">
          <p className="mb-3 text-center font-display text-legal tracking-[0.25em] text-zinc-500">
            Stay in the loop
          </p>
    ...
    <nav className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-legal text-zinc-500">
        ...
        <div
          ...
          aria-hidden
        />
        <p className="mt-10 text-legal text-zinc-600">
